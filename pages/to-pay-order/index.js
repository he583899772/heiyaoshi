  ...
  createOrder:function (e) {
    ...
    wx.request({
      ...
      success: (res) =>{
        ...
        postJsonString.keyword3 = { value: '订单已关闭，您可以重新下单，请在30分钟内完成支付', color:'#173177'}
        app.sendTempleMsg(res.data.data.id, -1,
          'XuuWfEQQkz8Nuuw5lCrkmA23WyRdgVLABnF_w0NpBSw', e.detail.formId,
        ...
        app.sendTempleMsg(res.data.data.id, 2,
          'aUXi5sSPoK3f82W6HCpyigzOXvU-YAyDzZVX8G0KUBE', e.detail.formId,
